        ...
        <div class="container d-flex flex-row ">
            <a class="navbar-brand" href="/">
                <img src="https://duploader.tech/assets/favicon/android-chrome-512x512.png?v=1704904973" alt="Bootstrap"
                    width="30" height="24"> SU Study Materials
            </a>
            ...
            <button class="btn btn-outline-dark navbtntoggle" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample"
                style="display: none;" aria-controls="offcanvasExample">
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasExampleLabel"><a class="navbar-brand" href="/">
                        <img src="https://duploader.tech/assets/favicon/android-chrome-512x512.png?v=1704904973"
                            alt="Bootstrap" width="30" height="24"> SU Study Materials
                    </a></h5>
