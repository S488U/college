            ...
            if (file_exists($fileLocation) && is_readable($fileLocation)) {
                ...
                switch ($fileExtension) {
                    ...
                    case 'docx':
                        $partToRemove = "/var/www/vhosts/dunite.tech/";
                        $resultLink = str_replace($partToRemove, '', $fileLocation);
                        https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2F$resultLink&wdOrigin=BROWSELINK
                        echo "<iframe loading='lazy' src='' width='100%' height='700' style='border-radius: 8px; margin-bottom: 40px;'></iframe>";
                        break;
                    case 'jpeg':
                    case 'jpg':
                    case 'webp':
