    ...
    foreach ($entries as $entry) {
        ...
        if (is_dir($fullPath)) {
            ...
            if (in_array($extension, $allowedExtensions)) {
                echo "<a class='custom-file-link' href='view?file=/IBM$encodedRelativePath/$encodedEntry' >$icon" . htmlspecialchars($entry) . "</a>";
            } else {
                echo "<a class='custom-file-link' href='/IBM/$encodedRelativePath/$encodedEntry' download>$icon" . htmlspecialchars($entry) . "</a>";
            }
            echo "</div>";
        }
    }
