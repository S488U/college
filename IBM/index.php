            ...
            foreach ($entries as $entry) {
                ...
                if (is_dir($fullPath)) {
                    ...
                    if (in_array($extension, $allowedExtensions)) {
                        ...
                        echo "<div class='custom-file'><a class='custom-file-link' href='view.php?file=/IBM$encodedRelativePath/$encodedEntry' target='_blank'>" . htmlspecialchars($entry) . "</a></div>"; // Generate the link
                    } else {
                        // Direct download link
                        echo "<div class='custom-file'><a class='custom-file-link' href='/IBM/$encodedRelativePath/$encodedEntry' download>" . htmlspecialchars($entry) . "</a></div>"; // Generate the link
                    }
                }
            }
        }
