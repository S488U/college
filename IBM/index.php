...
function displayFolderStructure($path, $rootDirectory)
{
    ...
    foreach ($entries as $entry) {
        ...
        if (is_dir($fullPath)) {
            ...
            $allowedExtensions = ["py", "cbp", "html", "pdf", "txt", "java", "cpp", "c", "sh", "css", "png", "jpeg", "jpg", "webp", "php"];
            ...
            if (in_array($extension, $allowedExtensions)) {
                echo "<div class='custom-file'><a class='custom-file-link' href='view.php?file=/IBM$encodedRelativePath/$encodedEntry' >" . htmlspecialchars($entry) . "</a></div>";
            } else {
                echo "<div class='custom-file'><a class='custom-file-link' href='/IBM/$encodedRelativePath/$encodedEntry' download>" . htmlspecialchars($entry) . "</a></div>";
            }
        }
    }
}
