...
<head>
    ...
    <meta name="description" content="Comprehensive MBA study materials coming soon. Contribute resources to help your peers.">
...
<body>
    ...
    <main class="container d-flex flex-column justify-content-center align-items-center gap-4 py-5">
        ...
        <div class="text-center mb-2">
            ...
            <p class="text-gray">Masters of Business Administration</p>
        </div>
        ...
        <div class="status-card">
            ...
            <p class="text-gray mb-4" style="line-height: 1.6;">
                We are currently gathering resources for the MBA department. 
