...
?>
    ...
    <body>
        ...
        <div class="container mt-5" style="min-height: 70vh; height: auto; position: relative;">
            <div class="tgl-btn container d-flex flex-row justify-content-center align-items-center">
                <div class="dark container-fluid p-1">Dark</div>
                <div class="light container-fluid p-1">light</div>
        </div>
        <style>
            .tgl-btn {
                width: 100px;
